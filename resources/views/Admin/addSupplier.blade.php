            ...
            <div class="form-group">
                ...
                <div class="card">
                    <div class="card-heading" style="background-color: #ffe4e1">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="{{route('AddSupplier.index')}}" class="btn btn-warning btn-cancel">Cancel</a>
                            </div>
                            <div class="col-sm-4">
                            </div>
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-danger btn-submit">Sign Up</button>
                                <input type="hidden" class="form-control" name="AccountType" value="Supplier">
                            </div>
                        </div>
                    </div>
                    <div class="card-body"> 
                        <div class="input-group">
                            ...
                            <span class="input-group-text"><i class="fa fa-user-o"></i></span>
                                ...
                                <input type="text" class="form-control" name="Fname" placeholder="Full Name" aria-describedby="sizing-addon1">
                            </div><br>
                            <div class="input-group">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="Phonenum" placeholder="Phone Number" aria-describedby="sizing-addon1">
                            </div><br>
                            <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="Email" placeholder="Email: example@email.com" aria-describedby="sizing-addon1">
                            </div><br>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="card-footer">
                        <div class="alert alert-danger" role="alert">
                            <div class="text-nowrap">
                                <p>About: <a href="#">Privacy and Policy</a></p>
                            </div>
                        </div>
                    </div>
                </div>
