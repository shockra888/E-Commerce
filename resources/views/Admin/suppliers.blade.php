...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Assets/css/suppliers.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top nav-under">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <form class="form-inline" method="get" action="{{url('searchsupplier')}}">
             <input class="form-control" name="query" id="search"  type="search" placeholder="Search" aria-label="Search">
             <button class="btn btn-outline-danger my-2 my-sm-0" type="submit">Search</button>
            </form>
            <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link nav-link-text" href="{{url('AdminHome')}}">Home</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        <div class="card border-danger bg-light mb-3">
            <div class="card-header">
                <h2>Suppliers<h2>
                    <a class="btn btn-danger btn-add" href="{{url('AddSupplier/create')}}">Add Supplier</a>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <td>{{$row->Gender}}</td>
                        <td>
                        <form method="post" class="delete_form" action="{{action('AddingSupplierController@destroy',$row->account_id)}}">
                            {{@csrf_field()}}
