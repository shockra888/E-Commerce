...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Assets/css/S_sales.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top nav-under">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
         ...
         <form class="form-inline" method="get" action="{{url('searchingsales')}}">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item active">
                <a class="nav-link nav-link-text" href="{{url('ViewSales')}}">Sales<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
