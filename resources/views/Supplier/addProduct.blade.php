            ...
            <div class="form-group">
                <div class="card">
                    <div class="card-heading" style="background-color: #ffe4e1">
                        <div class="row">
                            <div class="col-sm-4">
                            <a href="{{url('AddProduct/'.session('Active'))}}" class="btn btn-warning btn-cancel">Cancel</a>
                            </div>
                            <div class="col-sm-4">
                            </div>
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-danger btn-submit">Add</button>
                                {{@csrf_field()}}
                            </div>
                        </div>
                    </div>
                    <div class="card-body"> 
                        <div class="input-group">
                            ...
                            <span class="input-group-text"><i class="fa fa-product-hunt"></i></span>
                                ...
                                <input type="text" class="form-control" name="ProductName" placeholder="Product Name" aria-describedby="sizing-addon1">
                            </div><br>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <span class="input-group-text">$</span>
                                </div>
                                <input type="text" class="form-control" name="ProductPrice" placeholder="Product Price" aria-describedby="sizing-addon1">
                            </div><br>
                            <div class="input-group">
                                <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ProductQTY" placeholder="Product Quantity" aria-describedby="sizing-addon1">
                                <input type="hidden" name="id" value="{{session('Active')}}">
                            </div>
                        </div><br>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Product Details</label>
                            <textarea class="form-control" name="ProductDetails" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlFile1">Enter Product Image</label>
                            <input type="file"  name="ProductIMG" class="form-control-file" id="exampleFormControlFile1">
                        </div>
                    </div>
                </div>
            </div>
