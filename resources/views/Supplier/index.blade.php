...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Assets/css/s_index.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top nav-under">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item active">
                <a class="nav-link nav-link-text" href="{{URL('SupplierHome')}}">Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link nav-link-text" href="{{url('ViewSales')}}">Sales</a>
            </li>
            <li class="nav-item">
                <a class="nav-link nav-link-text" href="{{URL('AddProduct/'.session('Active'))}}">Products</a>
            </li>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="jumbotron text-center" id="img-log" >
                    ...
                    <h2 class="Mlabel">&#8369 {{$psales}}</h2>
                </div> 
            </div>
            <div class="col-sm-4">
                <div class="jumbotron text-center"id="img-log1" >
                    <h4 class="Mlabel">Number of Products</h4>
                    <h2 class="Mlabel">{{$pcount}}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card border-danger bg-light mb-3">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <td>
                            <img id="imageresource" src="/Assets/ProductImage/{{$row->product_image}}" width="65">
                        </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="card-footer">
                <a href="{{URL('AddProduct/'.session('Active'))}}" class="btn btn-danger btn-head">See All</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card border-danger bg-light mb-3">
            ...
            <div class="card-footer">
                <a href="{{url('ViewSales')}}" class="btn btn-danger btn-head">See All</a>
            </div>
        </div>
    </div>
