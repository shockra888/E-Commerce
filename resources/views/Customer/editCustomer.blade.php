...
<body>
    ...
    <center>
    <div class="container">
            <form method="post" action="{{action('AddingCustomerController@update',$id)}}">
                {{@csrf_field()}}
                <div class="card">
                    <div class="card-heading" style="background-color: #ffe4e1">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="{{URL('AddCustomer/'.session('Active'))}}" class="btn btn-warning btn-cancel">Cancel</a>
                            </div>
                            <div class="col-sm-4">
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="card-body"> 
                        <div class="input-group">
                            ...
                            <span class="input-group-text"><i class="fa fa-user-o"></i></span>
                                ...
                                <input type="text" class="form-control" name="Fname" placeholder="Full Name" aria-describedby="sizing-addon1" value="{{$editcustomer->Customer_Name}}">
                            </div><br>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-location-arrow"></i></span>
                                </div>
                                <input type="text" class="form-control" name="Address" placeholder="Address" aria-describedby="sizing-addon1" value="{{$editcustomer->Customer_Address}}" >
                            </div><br>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-phone"></i></span>
                                </div>
                                <input type="text" class="form-control" name="Phonenum" placeholder="Phone Number" aria-describedby="sizing-addon1" value="{{$editcustomer->Customer_Contact}}">
                            </div><br>
                            <div class="input-group">
