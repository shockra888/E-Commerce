    ...
    <div class="container">
        <div class="card bg-danger border-danger bg-light mb-3">
            <div class="card-header">
                <a href="{{route('AddOrder.create')}}" class="btn btn-danger btn-back">Back</a>
                <a href="{{action('AddingCustomerController@edit',$customerprofile->account_id)}}" class="btn btn-warning btn-out">Edit Profile</a>
            </div>
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <h1>{{$customerprofile->Customer_Name}}  ({{$customerprofile->account_id}})</h1>
                            <h3>{{$customerprofile->email}}</h3><br>
                            <h4>{{$customerprofile->Customer_Address}}</h4>
                            <h4>Phone: {{$customerprofile->Customer_Contact}}</h4>
                            <h4>Gender: {{$customerprofile->Gender}}</h4>
                        </div>
                    </div>
                </div>
            </div>
